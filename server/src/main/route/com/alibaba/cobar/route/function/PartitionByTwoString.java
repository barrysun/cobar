 ...
 *
 */
public class PartitionByTwoString extends PartitionFunction implements RuleAlgorithm {
    public PartitionByTwoString(String functionName) {
        this(functionName, null);
    }

    public PartitionByTwoString(String functionName, List<Expression> arguments) {
    ...
    private Integer[] eval(Object xInput, Object yInput) {
    	//start
    	if(xInput instanceof String && null != xInput && !xInput.equals("") && !xInput.equals("-")) {
    		Integer[] xArray = new Integer[1];
    		xArray[0] = calculate(xInput, partitionUtilX, keyTypeX, hashSliceStartX, hashSliceEndX);
        	return xArray;
        } else if(yInput instanceof String && null != yInput && !yInput.equals("") && !yInput.equals("-")) {
        	Integer[] yArray = new Integer[1];
        	yArray[0] = calculate(yInput, partitionUtilY, keyTypeY, hashSliceStartY, hashSliceEndY);
        	return yArray;
        }
    	//end
    ...
    public RuleAlgorithm constructMe(Object... objects) {
        ...
        PartitionByTwoString rst = new PartitionByTwoString(functionName, args);
        rst.countX = countX;
        rst.xSize = xSize;
        rst.lengthX = lengthX;
    ...
    public static void main(String[] args) throws Exception {
	    PartitionByTwoString func = new PartitionByTwoString("test999", new ArrayList<Expression>(2));
	    func.setKeyTypeX("long");
	    func.setPartitionCountX("1,4,1,4");
	    func.setPartitionLengthX("256,64,256,64");
	    func.setKeyTypeY("string");
	    func.setPartitionCountY("1,4,1,4");
	    func.setPartitionLengthY("256,64,256,64");
	    func.setHashLengthY(8);
	    func.init();
	    
	    Integer[] ints=func.eval(1023L, "zzfdfdfezzr");
	    for(Integer i:ints){
